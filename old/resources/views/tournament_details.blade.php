    ...
    <div class="container px-5 my-5 print-details">
        <div class="row gx-4 gx-lg-5 align-items-center my-5 print-details">
            ...
            <div class="col-lg-5">
                ...
                @endif
                <h6 class="card-subtitle mb-2  mt-2"><i class="far fa-calendar-alt mr-1 mb-2"></i> <b>Date: </b> <span>{{ date('M d Y', strtotime($tournament->date))}} - {{ date('M d Y', strtotime($tournament->end_date))}}</span> | <i class="far fa-clock mr-1"></i> <span>{{ date("h:i A", strtotime($tournament->time))}}</span> <br/> <i class="fa fa-map-marked-alt mr-1"></i> <b>Pre Tournament Meeting: </b> <span>{{$tournament->pre_meeting_location}}</span> | Host Hotel: {{$tournament->host_hotels}}
                  <div class="mt-2">
                ...
                @if($tournament->id !=10)
                    @auth
                            ...
                            @else
                                <button data="{{url('/tournament/participate/make-team')}}/{{$tournament->id}}" data-type="{{$tournament->free_paid}}" type="button" class="btn participate btn-primary btn-sm float-right">Register @if($tournament->free_paid == 'paid') - $2,000 @else - Free @endif</button>
                   ...
                   @else
                      <a href="{{url('/login')}}" class="btn btn-primary btn-sm float-right hide-print">Register @if($tournament->free_paid == 'paid') - $2,000 @else - Free @endif</a>
       ...
       {{-- <div class="row gx-4 gx-lg-5">
           ...
           ?>
                            ...
                            @else
                                <button data="{{url('/tournament/participate/make-team')}}/{{$t->id}}" data-type="{{$t->free_paid}}" type="button" class="btn participate btn-sm text-white float-right">Register @if($t->free_paid == 'paid') - $2,000 @else - Free @endif</button>
                            @endif
