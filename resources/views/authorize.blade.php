            ...
            <div class="card" style="margin:15px;">
                <div class="card-body">
                    @if($tournament !== NULL)
                        ...
                        <h6>Payment Amount: ${{ $tournament->tournament_price }}</h6>
                        <h6>Processing Fee 2.9%: ${{ round($tournament->tournament_price*.029) }}</h6>

                        <h6>Total Payment Amount: ${{ $tournament->tournament_price+round($tournament->tournament_price*.029) }}</h6>
                    @endif
        ...
        <div class="col-md-6">
            <div class="card" style="margin:15px;">
                ...
                <div class="form-check">
                    ...
                    <input type="text" id="cardNumber"  class="form-control" placeholder="cardNumber" name="cardNumber" required/></p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-check">
                            ...
                            <select class="form-control" aria-label="expMonth" id="expMonth" name="expMonth" required>
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-check">
                            ...
                            <select class="form-control" aria-label="expYear" id="expYear" name="expYear" required>
                ...
                <div class="form-check">
                    ...
                    <input type="text" id="cardCode"  class="form-control" placeholder="cardCode" name="cardCode" required/></p>
                </div>
