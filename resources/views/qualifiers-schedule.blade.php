...
<section>
  ...
  <div class="row">
    <div class="col-sm">
      <a href="https://americanbassclub.com/payouts"><button class="btn btn-primary w-100" style="background-color:#CC0000; border:1px solid #CC0000; margin-bottom:10px;font-weight:bold;"><i class="fa fa-money" aria-hidden="true"></i>
 Payouts</button></a>
    </div>
    
    
  <div class="col-sm">
      <a href="https://americanbassclub.com/northern-qualifier-results"><button class="btn btn-primary w-100" style="background-color:#CC0000; border:1px solid #CC0000; margin-bottom:10px;font-weight:bold;"><i class="fa fa-trophy" aria-hidden="true"></i> Results</button></a>
    </div></div>
</div>
            ...
            <div class="pricing__blk">
              <div class="row">
                <?php
                $tournaments = \App\Models\Tournament::where([['is_deleted', 0],['home_visible', 1], ['tournament_cat_id', 0]])->orderBy('date', 'ASC')->limit(20)->get()->filter(function ($item) {
