...
<section>
    ...
    <div class="col-sm d-flex justify-content-center" style="margin-top:75px!important">
            ...
            <div class="team__content__blk position-relative mt-50">
              ...
              <div class="team__content">
                <h2>Fishermans Central Invitational Schedule</h2>
              </div>
  ...
  <div class="row">
    <div class="col-sm">
      <a href="https://americanbassclub.com/pro-circuit-rules"><button class="btn btn-primary w-100" style="background-color:#CC0000; border:1px solid #CC0000; margin-bottom:10px;font-weight:bold;"><i class="fa fa-book" aria-hidden="true"></i>
 Rules</button></a>
    </div>
    
    
  <div class="col-sm">
      <a href="https://americanbassclub.com/payouts-pro-circuit"><button class="btn btn-primary w-100" style="background-color:#CC0000; border:1px solid #CC0000; margin-bottom:10px;font-weight:bold;"><i class="fa fa-money" aria-hidden="true"></i> Payouts</button></a>
    </div><div class="col-sm">
      <a href="https://americanbassclub.com/payouts-pro-circuit-championship"><button class="btn btn-primary w-100" style="background-color:#CC0000; border:1px solid #CC0000; margin-bottom:10px;font-weight:bold;"><i class="fa fa-trophy" aria-hidden="true"></i>
