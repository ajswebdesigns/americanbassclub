                              ...
                              <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check" id="single_player_visible">
                                          <input class="form-check-input" type="checkbox" value="1" id="single_player" name="single_player" @if($tournament->single_player == '1') checked @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tournament_price" placeholder="0.00" class="form-control" value='{{$tournament->tournament_price}}'>
                                    </div>
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <select class="form-select form-control" name="tournament_cat_id">
                                      ...
                                      @foreach($categories as $c)
                                        ...
                                        <option value="{{$c->cat_id}}" @if($c->cat_id == $tournament->tournament_cat_id) selected @endif >{{$c->cat_title}}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="payment_due_date" class="form-control"  id="tournament_due_date" value='{{$tournament->payment_deadline}}'>
                                    </div>
                                </div>
