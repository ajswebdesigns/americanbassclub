            ...
            <div class="col-md-12">
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Update {{$page->page_name}}</h3>
                        <a href="https://americanbassclub.com/pages/view"><button class="btn btn-primary">Back</button></a>
                    </div>
                    <div class="block-content">
<form method="POST" action="{{route('pageupdate', $page->id)}}">
    @csrf
       ...
       <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="summernote" name="page_content">{{$page->page_content}}</textarea>
        </div>
        <br/>
