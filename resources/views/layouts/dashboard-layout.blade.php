...
<body>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed  main-content-narrow">
        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{route('page_management', 'rules')}}">
                                        <i class="nav-main-link-icon fa fa-pencil-alt"></i>
                                        <span class="nav-main-link-name">Website Member Rules</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{url('/categories/view')}}">
                                <i class="nav-main-link-icon fa fa-pencil-alt"></i>
          ...
          <span class="badge badge-warning navbar-badge"> {{ DB::table('contactuses')->where('read_status', 0)->count() }}  </span>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{route('send_email_to_all_users')}}">
                                <i class="nav-main-link-icon fa fa-inbox"></i>
                        ...
                        <!--New Test-->
                         <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{url('/pages/add')}}">
                                        <i class="nav-main-link-icon fa fa-plus"></i>
                                        <span class="nav-main-link-name">Add New Page</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{url('/pages/view')}}">
                                        <i class="nav-main-link-icon fa fa-pencil-alt"></i>
                                        <span class="nav-main-link-name">Manage</span>
                                    </a>
                                </li>
                         ...
                         <li class="nav-main-item">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{route('MyTournaments')}}">
                                        <i class="nav-main-link-icon fa fa-trophy"></i>
                                        <span class="nav-main-link-name">Registered Events</span>
                                    </a>
                                </li>
                                  <li class="nav-main-item">
                                    <a class="nav-main-link" href="https://www-americanbassclub.myshopify.com/" target="_blank">
    ...
    jQuery(document).ready(function(){
        ...
        $('input:radio[name="paymentMethod"]').change(
            ...
            $('input:radio[name="free_paid"]').change(
            function(){
                if ($(this).is(':checked') && $(this).val() == 'paid') {
                     $( "#single_player" ).prop( "checked", false );
                     $('#single_player_visible').show();


                }else{
                     $( "#single_player" ).prop( "checked", false );
                     $('#single_player_visible').hide();
