...
<!-- =================== HERO AREA START ===================== -->
<section>
  <div class="hero__area position-relative" style="background-image: url(./img/homepage-hero.png);">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
...
<section>
    <div class="container">
        <div class="row">
            <h2 style="font-size: 30px; font-weight:700;" class="text-center">Welcome</h2>
            <div class="col-sm d-flex justify-content-center">
                <iframe id="ytplayer" type="text/html" width="720" height="405" src="https://www.youtube.com/embed/9342XiP7CeY" frameborder="0" allowfullscreen></iframe>
          ...
          <div class="team__wrapper">
            <div class="team__content__blk position-relative">
              <div class="team__content">
                <h2>Events Sponsored By</h2>
              </div>
              <span class="flag__shape"><img src="/img/flag__shape.png" alt=""></span>
            </div>
            <div class="fishermans-central mt-3 mb-3 ">
                  <img class="rounded mx-auto d-block" src="https://americanbassclub.com/img/fishermans-central.png">
            </div>
            ...
            <div class="team__content__blk position-relative mt-60">
              <div class="team__content">
                <h2>Register Today Events Fill Up Fast!</h2>
